...
var algos = module.exports = global.algos = {
	...
	whirlpoolx: {
        hash: function(){
            return function(){
                return multiHashing.whirlpoolx.apply(this, arguments);
            }
        }
    },
	lyra2re: {
    ...
    lyra2h: {
        ...
        hash: function(){
            return function(){
                return multiHashing.lyra2h.apply(this, arguments);
            }
        }
    },
	tribus: {
	...
	skunk: {
        hash: function(){
            return function(){
                return multiHashing.skunk.apply(this, arguments);
            }
        }
    },
	jha: {
        ...
        hash: function(){
            return function(){
                return multiHashing.jha.apply(this, arguments);
            }
        }
    },
    qubit: {
    ...
    hsr: {
        hash: function(){
            return function(){
                return multiHashing.hsr.apply(this, arguments);
            }
        }
    },
	neoscrypt: {
